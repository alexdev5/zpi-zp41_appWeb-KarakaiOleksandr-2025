<template>
    ...
    >
        <Lab4Target v-if="navigationItemActive === NavigationIdLab4.Target" />
        ...
        <Lab4Task8 v-if="navigationItemActive === NavigationIdLab4.Task8" />
        <Lab4Task9 v-if="navigationItemActive === NavigationIdLab4.Task9" />
        <Lab4Task10 v-if="navigationItemActive === NavigationIdLab4.Task10" />
    </AppPageContent>
</template>

<script lang="ts" setup>
import AppPageContent from '@/components/layout/app-page-content/app-page-content.component.vue'
import Lab4Target from './components/lab-4-target.component.vue'
...
import Lab4Task8 from './components/lab-4-task8.component.vue'
import Lab4Task9 from './components/lab-4-task9.component.vue'
import Lab4Task10 from './components/lab-4-task10.component.vue'

import { ref } from 'vue'
import type { AsideNavigationRecord } from '@/components/layout/types.ts'
import { NavigationIdLab4 } from '@/views/lab-4/type.ts'

const navigationItemActive = ref(NavigationIdLab4.Target)
const records: AsideNavigationRecord[] = [
    {
        id: NavigationIdLab4.Target,
        label: 'Тема, мета, мізце розташування',
    },
    {
        id: NavigationIdLab4.Task2,
        label: 'ЗАВДАННЯ №2',
    },
    {
        id: NavigationIdLab4.Task4,
        label: 'ЗАВДАННЯ №4',
    },
    {
    ...
    {
        id: NavigationIdLab4.Task8,
        label: 'ЗАВДАННЯ №8',
    },
    {
        id: NavigationIdLab4.Task9,
        label: 'ЗАВДАННЯ №9',
    },
    {
        id: NavigationIdLab4.Task10,
        label: 'ЗАВДАННЯ №10',
    },
]
</script>
